...
- Command line to run =combine nocat_datacard.txt --run blind --rMin 100 --rMax 1000=
...
- With v10, I am running the combine with same command. I wan to run it with simple options like: =combine -t -1 nocat_datacard.txt -m 5.36688=
